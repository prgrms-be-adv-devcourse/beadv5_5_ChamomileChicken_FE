      ...
      <div class="card w-full bg-base-100 shadow-sm border border-base-300/30 rounded-[40px] overflow-hidden animate-in fade-in zoom-in duration-500">
        <div class="card-body p-8 lg:p-12">
          ...
          <div class="flex flex-col gap-3">
            <button @click="loginWithSocial('google')" class="btn btn-lg bg-white hover:bg-base-200 text-base-content border border-base-300/50 rounded-2xl font-black h-14 transition-all gap-3">
            ...
            <button @click="loginWithSocial('kakao')" class="btn btn-lg bg-[#FEE500] text-[#191919] hover:bg-[#FADA00] border-none rounded-2xl font-black h-14 transition-all gap-3">
              <svg class="w-6 h-6" viewBox="0 0 24 24" fill="#191919">
            ...
            <button @click="loginWithSocial('naver')" class="btn btn-lg bg-[#03C75A] text-white hover:bg-[#02b350] border-none rounded-2xl font-black h-14 transition-all gap-3">
